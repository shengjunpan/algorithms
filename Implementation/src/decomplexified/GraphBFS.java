...
public abstract class GraphBFS<T> {
    ...
    public abstract boolean Process(GraphNode<T> node);
            ...
            for (GraphNode<T> node : justVisited) {
                for (GraphNode<T> neighbor : node.neighbors) {
                    ...
                    if (!previousVisited.contains(neighbor) &&
                        ...
                        // order of nodes at the same level may vary
    ...
    public static void main(String[] args) {
        ...
        GraphNode<Integer> root = GraphNode.buildGraph(values, families);
        ...
        GraphNode<Integer> root2 = GraphNode.buildGraph(values2, families2);
        bfs.traverse(root2);
    }
}
